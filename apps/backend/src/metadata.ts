...
export default async () => {
  const t = {
    ...
    ['./config/types/app.config.type']: await import('./config/types/app.config.type'),
    ...
    '@nestjs/swagger': {
      'models': [[import('./roles/entities/role.entity'), {
        ...
        'File': {
          ...
          storageType: { required: true, type: () => String, enum: t['./config/types/app.config.type'].StorageType },
