...
export default async () => {
  const t = {
    ...
    ['./tasks/entities/priority-translation.entity']: await import('./tasks/entities/priority-translation.entity'),
    ...
    ['./projects/dtos/project-category-translation.dto']: await import(
      './projects/dtos/project-category-translation.dto'
    ),
    ...
    ['./tasks/dtos/priority.dto']: await import('./tasks/dtos/priority.dto'),
    ['./projects/dtos/project-category.dto']: await import('./projects/dtos/project-category.dto'),
    ['./projects/dtos/project-role.dto']: await import('./projects/dtos/project-role.dto'),
    ['./projects/dtos/project-status.dto']: await import('./projects/dtos/project-status.dto'),
    ['./projects/dtos/project-type.dto']: await import('./projects/dtos/project-type.dto'),
    ...
    '@nestjs/swagger': {
      'models': [[import('./core/language/entities/language.entity'), {
        ...
        'Priority': {
          ...
          translations: {
            required: true,
            type: () => [t['./tasks/entities/priority-translation.entity'].PriorityTranslation],
          },
        },
      }], [import('./tasks/entities/priority-translation.entity'), {
        'PriorityTranslation': {
          id: { required: true, type: () => Number },
          name: { required: true, type: () => String },
        ...
        'CreateProjectCategoryDto': {
          translations: {
            required: true,
            type: () => [t['./projects/dtos/project-category-translation.dto'].ProjectCategoryTranslationDto],
          },
          color: {
            required: true,
            type: () => String,
      ...
      }], [import('./projects/dtos/project-status-translation.dto'), {
        'ProjectStatusTranslationDto': {
          languageCode: {
            required: true,
            type: () => String,
          },
        ...
        'CreateProjectStatusDto': {
          translations: {
            required: true,
            type: () => [t['./projects/dtos/project-status-translation.dto'].ProjectStatusTranslationDto],
          },
          color: {
            required: true,
            type: () => String,
      ...
      }], [import('./projects/dtos/project-type-translation.dto'), {
        'ProjectTypeTranslationDto': {
          languageCode: {
            required: true,
            type: () => String,
          },
      ...
      }], [import('./projects/dtos/create-project-type.dto'), {
        'CreateProjectTypeDto': {
          translations: {
            required: true,
            type: () => [t['./projects/dtos/project-type-translation.dto'].ProjectTypeTranslationDto],
          },
        },
      ...
      }], [import('./projects/dtos/update-project-type.dto'), {
      ...
      'controllers': [[import('./app.controller'), { 'AppController': { 'getHello': { type: String } } }], [
        ...
        'TasksController': {
          ...
          'remove': {},
          'getPriorities': { type: [t['./tasks/dtos/priority.dto'].PriorityDto] },
          'createComment': { type: t['./tasks/entities/task-comment.entity'].TaskComment },
          'getTaskComments': { type: [t['./tasks/entities/task-comment.entity'].TaskComment] },
          'removeComment': {},
        ...
        'ProjectCategoryController': {
          'getProjectCategories': { type: [t['./projects/dtos/project-category.dto'].ProjectCategoryDto] },
        ...
        'ProjectRoleController': { 'findAll': { type: [t['./projects/dtos/project-role.dto'].ProjectRoleDto] } },
      }], [import('./projects/controllers/project-status.controller'), {
        'ProjectStatusController': {
          'getProjectStatuses': { type: [t['./projects/dtos/project-status.dto'].ProjectStatusDto] },
        ...
        'ProjectTypeController': {
          'getAll': { type: [t['./projects/dtos/project-type.dto'].ProjectTypeDto] },
          'create': { type: t['./projects/entities/project-type.entity'].ProjectType },
          'findOne': { type: t['./projects/entities/project-type.entity'].ProjectType },
          'update': { type: t['./projects/entities/project-type.entity'].ProjectType },
          'remove': {},
        },
        ...
        'ProjectsController': {
          ...
          'findOneWithDetails': { type: t['./projects/entities/project.entity'].Project },
