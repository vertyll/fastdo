...
export default async () => {
  const t = {
    ...
    ['./projects/entities/project-category-translation.entity']: await import(
      './projects/entities/project-category-translation.entity'
    ),
    ['./projects/entities/project-status.entity']: await import('./projects/entities/project-status.entity'),
    ['./projects/entities/project-status-translation.entity']: await import(
    ...
    ['./tasks/entities/task-priority-translation.entity']: await import(
      './tasks/entities/task-priority-translation.entity'
    ),
    ...
    ['./projects/entities/project-role-permission.entity']: await import(
      './projects/entities/project-role-permission.entity'
    ),
    ['./projects/enums/project-role-permission.enum']: await import('./projects/enums/project-role-permission.enum'),
    ['./projects/entities/project-role-permission-translation.entity']: await import(
      './projects/entities/project-role-permission-translation.entity'
    ),
    ...
    ['./tasks/dtos/task-comment.dto']: await import('./tasks/dtos/task-comment.dto'),
    ...
    ['./projects/enums/project-invitation-status.enum']: await import(
      './projects/enums/project-invitation-status.enum'
    ),
    ...
    ['./tasks/entities/task-status-translation.entity']: await import(
  ...
  return {
    '@nestjs/swagger': {
      'models': [[import('./core/language/entities/language.entity'), {
        'Language': {
          id: { required: true, type: () => Number },
          code: { required: true, enum: t['./core/language/enums/language-code.enum'].LanguageCodeEnum },
      ...
      }], [import('./projects/entities/project-role-translation.entity'), {
        'ProjectRoleTranslation': {
          ...
          projectRole: { required: true, type: () => t['./projects/entities/project-role.entity'].ProjectRole },
          language: { required: true, type: () => t['./core/language/entities/language.entity'].Language },
        },
        ...
        'RefreshToken': {
          ...
          dateExpiration: { required: true, type: () => Date },
        ...
        'Role': {
          id: { required: true, type: () => Number },
          code: { required: true, enum: t['./common/enums/role.enum'].RoleEnum },
          isActive: { required: true, type: () => Boolean },
          dateCreation: { required: true, type: () => Date },
          dateModification: { required: true, type: () => Date },
        ...
        'ProjectCategoryTranslation': {
          ...
          projectCategory: {
            required: true,
            type: () => t['./projects/entities/project-category.entity'].ProjectCategory,
          },
        },
      }], [import('./projects/entities/project-category.entity'), {
        'ProjectCategory': {
          id: { required: true, type: () => Number },
          ...
          translations: {
            required: true,
            type: () => [t['./projects/entities/project-category-translation.entity'].ProjectCategoryTranslation],
          },
        },
      }], [import('./projects/entities/project-status-translation.entity'), {
        'ProjectStatusTranslation': {
          id: { required: true, type: () => Number },
          name: { required: true, type: () => String },
          description: { required: true, type: () => String, nullable: true },
          language: { required: true, type: () => t['./core/language/entities/language.entity'].Language },
          projectStatus: { required: true, type: () => t['./projects/entities/project-status.entity'].ProjectStatus },
        },
      }], [import('./projects/entities/project-status.entity'), {
        'ProjectStatus': {
          id: { required: true, type: () => Number },
          color: { required: true, type: () => String },
          isActive: { required: true, type: () => Boolean },
          ...
          translations: {
            required: true,
            type: () => [t['./projects/entities/project-status-translation.entity'].ProjectStatusTranslation],
          },
        },
      }], [import('./tasks/entities/task-attachment.entity'), {
        'TaskAttachment': {
          id: { required: true, type: () => Number },
          dateCreation: { required: true, type: () => Date },
          dateModification: { required: true, type: () => Date },
          task: { required: true, type: () => t['./tasks/entities/task.entity'].Task },
          file: { required: true, type: () => t['./core/file/entities/file.entity'].File },
        },
      }], [import('./tasks/entities/task-comment-attachment.entity'), {
        'TaskCommentAttachment': {
          id: { required: true, type: () => Number },
          dateCreation: { required: true, type: () => Date },
          dateModification: { required: true, type: () => Date },
          comment: { required: true, type: () => t['./tasks/entities/task-comment.entity'].TaskComment },
          file: { required: true, type: () => t['./core/file/entities/file.entity'].File },
        },
      }], [import('./tasks/entities/task-comment.entity'), {
        'TaskComment': {
          id: { required: true, type: () => Number },
          content: { required: true, type: () => String },
          dateCreation: { required: true, type: () => Date },
          ...
          commentAttachments: {
            required: true,
            type: () => [t['./tasks/entities/task-comment-attachment.entity'].TaskCommentAttachment],
          },
        },
      }], [import('./tasks/entities/task-priority-translation.entity'), {
        'TaskPriorityTranslation': {
          ...
          dateModification: { required: true, type: () => Date },
          language: { required: true, type: () => t['./core/language/entities/language.entity'].Language },
          priority: { required: true, type: () => t['./tasks/entities/task-priority.entity'].TaskPriority },
        },
      }], [import('./tasks/entities/task-priority.entity'), {
        'TaskPriority': {
          id: { required: true, type: () => Number },
          code: { required: true, enum: t['./tasks/enums/task-priority.enum'].TaskPriorityEnum },
          color: { required: true, type: () => String },
          isActive: { required: true, type: () => Boolean },
          dateCreation: { required: true, type: () => Date },
          dateModification: { required: true, type: () => Date },
          translations: {
            required: true,
            type: () => [t['./tasks/entities/task-priority-translation.entity'].TaskPriorityTranslation],
          },
        },
        ...
        'Task': {
          ...
          priceEstimation: { required: true, type: () => Number },
          workedTime: { required: true, type: () => Number },
          accessRole: { required: false, type: () => t['./projects/entities/project-role.entity'].ProjectRole },
          dateCreation: { required: true, type: () => Date },
          dateModification: { required: true, type: () => Date },
          project: { required: true, type: () => t['./projects/entities/project.entity'].Project },
          assignedUsers: { required: true, type: () => [t['./users/entities/user.entity'].User] },
          ...
          status: {
            required: true,
            type: () => t['./projects/entities/project-status.entity'].ProjectStatus,
            nullable: true,
          },
          taskAttachments: {
            required: true,
      ...
      }], [import('./projects/entities/project-type-translation.entity'), {
        'ProjectTypeTranslation': {
          id: { required: true, type: () => Number },
          name: { required: true, type: () => String },
          description: { required: true, type: () => String, nullable: true },
          language: { required: true, type: () => t['./core/language/entities/language.entity'].Language },
          projectType: { required: true, type: () => t['./projects/entities/project-type.entity'].ProjectType },
        },
      }], [import('./projects/entities/project-type.entity'), {
        'ProjectType': {
          id: { required: true, type: () => Number },
          code: { required: true, enum: t['./projects/enums/project-type.enum'].ProjectTypeEnum },
          isActive: { required: true, type: () => Boolean },
          projects: { required: true, type: () => [t['./projects/entities/project.entity'].Project] },
          translations: {
            required: true,
            type: () => [t['./projects/entities/project-type-translation.entity'].ProjectTypeTranslation],
          },
        },
        ...
        'Project': {
          ...
          icon: { required: true, type: () => t['./core/file/entities/file.entity'].File, nullable: true },
          isActive: { required: true, type: () => Boolean },
          dateCreation: { required: true, type: () => Date },
          dateModification: { required: true, type: () => Date, nullable: true },
          type: {
            required: true,
            type: () => t['./projects/entities/project-type.entity'].ProjectType,
            nullable: true,
          },
        ...
        'ProjectUserRole': {
          ...
          user: { required: true, type: () => t['./users/entities/user.entity'].User },
          projectRole: { required: true, type: () => t['./projects/entities/project-role.entity'].ProjectRole },
          dateAssigned: { required: true, type: () => Date },
        },
      }], [import('./projects/entities/project-role.entity'), {
        'ProjectRole': {
          id: { required: true, type: () => Number },
          code: { required: true, enum: t['./projects/enums/project-role.enum'].ProjectRoleEnum },
          isActive: { required: true, type: () => Boolean },
          dateCreation: { required: true, type: () => Date },
          dateModification: { required: true, type: () => Date },
          translations: {
            required: true,
            type: () => [t['./projects/entities/project-role-translation.entity'].ProjectRoleTranslation],
          },
          userRoles: {
            required: true,
            type: () => [t['./projects/entities/project-user-role.entity'].ProjectUserRole],
          ...
          permissions: {
            required: true,
            type: () => [t['./projects/entities/project-role-permission.entity'].ProjectRolePermission],
          },
        },
      }], [import('./projects/entities/project-role-permission.entity'), {
        'ProjectRolePermission': {
          id: { required: true, type: () => Number },
          code: { required: true, enum: t['./projects/enums/project-role-permission.enum'].ProjectRolePermissionEnum },
          isActive: { required: true, type: () => Boolean },
          dateCreation: { required: true, type: () => Date },
          dateModification: { required: true, type: () => Date },
          translations: {
            required: true,
            type: () => [
              t['./projects/entities/project-role-permission-translation.entity'].ProjectRolePermissionTranslation,
            ],
          },
          roles: { required: true, type: () => [t['./projects/entities/project-role.entity'].ProjectRole] },
        },
      }], [import('./projects/entities/project-role-permission-translation.entity'), {
        ...
        'CreateNotificationDto': {
          ...
          sendEmail: { required: false, type: () => Boolean, default: true },
        },
      }], [import('./notifications/dtos/update-notification-settings.dto'), {
        'UpdateNotificationSettingsDto': {
          emailNotifications: { required: false, type: () => Boolean },
          appNotifications: { required: false, type: () => Boolean },
          projectInvitations: { required: false, type: () => Boolean },
          taskAssignments: { required: false, type: () => Boolean },
          taskComments: { required: false, type: () => Boolean },
          taskStatusChanges: { required: false, type: () => Boolean },
          projectUpdates: { required: false, type: () => Boolean },
          systemNotifications: { required: false, type: () => Boolean },
        },
      }], [import('./notifications/entities/notification-settings.entity'), {
        'NotificationSettings': {
          id: { required: true, type: () => Number },
          emailNotifications: { required: true, type: () => Boolean },
          appNotifications: { required: true, type: () => Boolean },
          projectInvitations: { required: true, type: () => Boolean },
          taskAssignments: { required: true, type: () => Boolean },
          taskComments: { required: true, type: () => Boolean },
          taskStatusChanges: { required: true, type: () => Boolean },
          projectUpdates: { required: true, type: () => Boolean },
      ...
      }], [import('./tasks/dtos/create-task-comment.dto'), {
        'CreateTaskCommentDto': {
          ...
          attachments: { required: false, type: () => [Object] },
        },
        ...
        'GetAllTasksSearchParamsDto': {
          ...
          sortBy: { required: false, enum: t['./tasks/enums/task-sort-by.enum'].TaskSortByEnum },
          orderBy: { required: false, enum: t['./common/enums/order-by.enum'].OrderByEnum },
      ...
      }], [import('./tasks/dtos/task-comment.dto'), {
        'TaskCommentDto': {
          id: { required: true, type: () => Number },
          content: { required: true, type: () => String },
          dateCreation: { required: true, type: () => Date },
          dateModification: { required: true, type: () => Date },
          author: { required: true, type: () => t['./users/entities/user.entity'].User },
          attachments: { required: true, type: () => [t['./core/file/entities/file.entity'].File] },
        },
        ...
        'TaskResponseDto': {
          ...
          attachments: { required: true, type: () => [t['./core/file/entities/file.entity'].File] },
          comments: { required: true, type: () => [t['./tasks/dtos/task-comment.dto'].TaskCommentDto] },
        },
        ...
        'UpdateTaskCommentDto': {
          ...
          attachments: { required: false, type: () => [Object] },
          attachmentsToDelete: { required: false, type: () => [String] },
        },
      ...
      }], [import('./projects/dtos/project-category-response.dto'), {
      ...
      }], [import('./projects/dtos/project-role-response.dto'), {
      ...
      }], [import('./projects/dtos/project-status-response.dto'), {
      ...
      }], [import('./projects/dtos/project-type-response.dto'), {
        ...
        'UpdateProjectRoleDto': { role: { required: true, type: () => Number } },
      }], [import('./users/dtos/user.dto'), {
        'UserDto': { id: { required: true, type: () => Number }, name: { required: true, type: () => String } },
      }], [import('./projects/dtos/accept-invitation.dto'), {
        'AcceptInvitationDto': { invitationId: { required: true, type: () => Number } },
      }], [import('./projects/dtos/user-with-role.dto'), {
        'UserWithRoleDto': {
          email: {
            required: true,
            type: () => String,
        ...
        'CreateProjectDto': {
          ...
          typeId: { required: false, type: () => Number },
          categories: { required: false, type: () => [String] },
          statuses: { required: false, type: () => [String] },
          usersWithRoles: { required: false, type: () => [t['./projects/dtos/user-with-role.dto'].UserWithRoleDto] },
      ...
      }], [import('./projects/dtos/project-details-response.dto'), {
        'ProjectDetailsResponseDto': {
          ...
          icon: {
            required: true,
            type: () => ({ url: { required: true, type: () => String, nullable: true } }),
            nullable: true,
          },
          isActive: { required: true, type: () => Boolean },
          dateCreation: { required: true, type: () => Date },
          dateModification: { required: false, type: () => Date, nullable: true },
          type: { required: false },
          categories: { required: false },
          statuses: { required: false },
          permissions: { required: false, type: () => [String] },
          projectUserRoles: { required: false },
        },
      }], [import('./projects/dtos/project-list-response.dto'), {
      ...
      }], [import('./projects/dtos/reject-invitation.dto'), {
        'RejectInvitationDto': { invitationId: { required: true, type: () => Number } },
      ...
      }], [import('./projects/entities/project-invitation.entity'), {
        'ProjectInvitation': {
          id: { required: true, type: () => Number },
          project: { required: true, type: () => t['./projects/entities/project.entity'].Project },
          user: { required: true, type: () => t['./users/entities/user.entity'].User },
          inviter: { required: true, type: () => t['./users/entities/user.entity'].User },
          role: { required: true, type: () => t['./projects/entities/project-role.entity'].ProjectRole },
          status: {
            required: true,
            enum: t['./projects/enums/project-invitation-status.enum'].ProjectInvitationStatusEnum,
          },
        ...
        'PrivacyPolicySectionDto': {
          id: { required: true, type: () => Number },
          order: { required: true, type: () => Number },
          type: { required: true, type: () => String },
          translations: {
            required: true,
            type: () => [t['./terms-and-policies/dtos/privacy-policy.dto'].PrivacyPolicySectionTranslationDto],
          },
        },
        'PrivacyPolicyDto': {
          id: { required: true, type: () => Number },
          ...
          sections: {
            required: true,
            type: () => [t['./terms-and-policies/dtos/privacy-policy.dto'].PrivacyPolicySectionDto],
          },
        },
        ...
        'TermsSectionDto': {
          ...
          translations: {
            required: true,
            type: () => [t['./terms-and-policies/dtos/terms.dto'].TermsSectionTranslationDto],
          },
        },
        'TermsDto': {
          id: { required: true, type: () => Number },
        ...
        'TaskCategory': {
          ...
          translations: {
            required: true,
            type: () => [t['./tasks/entities/task-category-translation.entity'].TaskCategoryTranslation],
          },
        },
      }], [import('./tasks/entities/task-category-translation.entity'), {
        'TaskCategoryTranslation': {
          id: { required: true, type: () => Number },
          name: { required: true, type: () => String },
          description: { required: false, type: () => String },
          language: { required: true, type: () => t['./core/language/entities/language.entity'].Language },
          taskCategory: { required: true, type: () => t['./tasks/entities/task-category.entity'].TaskCategory },
        },
      }], [import('./tasks/entities/task-status.entity'), {
        'TaskStatus': {
          id: { required: true, type: () => Number },
          color: { required: true, type: () => String },
          isActive: { required: true, type: () => Boolean },
          ...
          translations: {
            required: true,
            type: () => [t['./tasks/entities/task-status-translation.entity'].TaskStatusTranslation],
          },
        },
      }], [import('./tasks/entities/task-status-translation.entity'), {
      ...
      }], [import('./projects/dtos/project-invitation.dto'), {
        'ProjectInvitationDto': {
          id: { required: true, type: () => Number },
          projectId: { required: true, type: () => Number },
          userId: { required: true, type: () => Number },
          inviterId: { required: true, type: () => Number },
      ...
      'controllers': [[import('./app.controller'), { 'AppController': { 'getHello': { type: String } } }], [
        import('./roles/controllers/roles.controller'),
        { 'RolesController': { 'getAllRoles': { type: [t['./roles/dtos/role.dto'].RoleDto] } } },
      ...
      }], [import('./notifications/controllers/notification.controller'), {
        'NotificationController': {
          ...
          'getMySettings': { type: t['./notifications/entities/notification-settings.entity'].NotificationSettings },
          'updateMySettings': { type: t['./notifications/entities/notification-settings.entity'].NotificationSettings },
          'markMyAsRead': {},
          'getUserNotifications': { type: [t['./notifications/entities/notification.entity'].Notification] },
          'getUnreadCount': { type: Number },
          'markAsRead': {},
          'markAllAsRead': {},
          'getUserSettings': { type: t['./notifications/entities/notification-settings.entity'].NotificationSettings },
          'updateUserSettings': {
        ...
        'TaskPriorityController': {
          'findAll': { type: [t['./tasks/dtos/task-priority-response.dto'].TaskPriorityResponseDto] },
        },
        ...
        'TasksController': {
          ...
          'findAll': {},
          'findAllByProjectId': {},
          'findOne': { type: t['./tasks/dtos/task-response.dto'].TaskResponseDto },
          'update': { type: t['./tasks/dtos/task-response.dto'].TaskResponseDto },
          'remove': {},
          'batchDelete': {},
          'createComment': { type: t['./tasks/entities/task-comment.entity'].TaskComment },
          'removeComment': {},
        ...
        'ProjectCategoryController': {
          'getProjectCategories': {
            type: [t['./projects/dtos/project-category-response.dto'].ProjectCategoryResponseDto],
          },
          'createCategory': { type: t['./projects/entities/project-category.entity'].ProjectCategory },
          'updateCategory': { type: t['./projects/entities/project-category.entity'].ProjectCategory },
          'deleteCategory': {},
        },
      }], [import('./projects/controllers/project-role.controller'), {
        'ProjectRoleController': {
          'findAll': { type: [t['./projects/dtos/project-role-response.dto'].ProjectRoleResponseDto] },
        },
      }], [import('./projects/controllers/project-status.controller'), {
        'ProjectStatusController': {
          'getProjectStatuses': { type: [t['./projects/dtos/project-status-response.dto'].ProjectStatusResponseDto] },
          'createStatus': { type: t['./projects/entities/project-status.entity'].ProjectStatus },
          'updateStatus': { type: t['./projects/entities/project-status.entity'].ProjectStatus },
          'deleteStatus': {},
        },
      }], [import('./projects/controllers/project-type.controller'), {
        'ProjectTypeController': {
          'getAll': { type: [t['./projects/dtos/project-type-response.dto'].ProjectTypeResponseDto] },
        },
      }], [import('./projects/controllers/project-user-role.controller'), {
        'ProjectUserRoleController': {
          'assignRole': { type: t['./projects/entities/project-user-role.entity'].ProjectUserRole },
          'getProjectRoles': { type: [t['./projects/entities/project-user-role.entity'].ProjectUserRole] },
          'getUserRoles': { type: [t['./projects/entities/project-user-role.entity'].ProjectUserRole] },
        ...
        'ProjectsController': {
          ...
          'getProjectUsers': { type: [t['./users/dtos/user.dto'].UserDto] },
          'findOneWithDetails': { type: t['./projects/dtos/project-details-response.dto'].ProjectDetailsResponseDto },
