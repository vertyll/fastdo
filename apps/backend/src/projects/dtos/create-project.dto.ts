...
export class CreateProjectDto {
  ...
  @ApiProperty({ description: 'Whether the project is public', required: false, default: false })
  @IsOptional()
  @IsBoolean()
  isPublic?: boolean;
  ...
  @ApiProperty({ description: 'Array of category names to create for this project', required: false })
  @IsOptional()
  @Transform(({ value }) => {
  ...
  @ApiProperty({ description: 'Array of status names to create for this project', required: false })
  @IsOptional()
  @Transform(({ value }) => {
    if (typeof value === 'string') {
      return [value];
