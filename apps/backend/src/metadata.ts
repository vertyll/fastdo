...
export default async () => {
  const t = {
    ...
    ['./file/enums/storage-type.enum']: await import('./file/enums/storage-type.enum'),
    ...
    '@nestjs/swagger': {
      'models': [[import('./roles/entities/role.entity'), {
        ...
        'File': {
          ...
          storageType: { required: true, type: () => String, enum: t['./file/enums/storage-type.enum'].StorageType },
